...
<div align="center">
  ...
  <p align="center">
    Track any Solana wallet transactions in Real Time
    <br />
...
5. In your `Supabase` dashboard go to `Project Settings` -> `Database` paste the connection string like this:
```js
...
[product-screenshot]: public/handi-ss1.png
